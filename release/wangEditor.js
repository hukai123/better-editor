...
Video.prototype = {
    ...
    _createPanel: function _createPanel() {
        ...
        var panel = new Panel(this, {
            ...
            tabs: [{
                ...
                '<div style="display:none;">\n                        <input id="' + upFileId + '" type="file" multiple="multiple" accept="audio/mp4, video/mp4"/,video/*>\n                    ' +
                '</div>\n                            </div>',
                events: [{
                    // 触发选择视频
            ...
            },
            {
                ...
                title: '插入视频',
                // 模板
                tpl: '<div>\n                        <input id="' + textValId + '" type="text" class="block" placeholder="视频链接"/>\n                        <div class="w-e-button-container">\n                            <button id="' + btnId + '" class="right">\u63D2\u5165</button>\n                        </div>\n                    </div>',
                // 事件绑定
                events: [{
                    selector: '#' + btnId,
                    type: 'click',
    ...
    _insert: function _insert(val) {
        ...
        editor.uploadVideo.insertLinkVideo(val)
...
UploadImg.prototype = {
    ...
    insertLinkImg: function insertLinkImg(link) {
        ...
        img.onerror = function () {
            img = null;
            // 无法成功下载图片
            _this._alert('插入图片错误', 'wangEditor: \u63D2\u5165\u56FE\u7247\u51FA\u9519\uFF0C\u56FE\u7247\u94FE\u63A5\u662F "' + link + '"\uFF0C\u4E0B\u8F7D\u8BE5\u94FE\u63A5\u5931\u8D25');
            return;
        };
...
UploadVideo.prototype = {
    ...
    insertLinkVideo:function(link){
      ...
      editor.cmd.do('insertHTML', '<video src="' + link + '" style="width:100%;height: 50%;" controls autobuffer autoplay muted x5-playsinline="" playsinline="" webkit-playsinline=""/>');
